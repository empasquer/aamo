...
<template>
  ...
  <a
    ...
    class="fixed right-0 bottom-12 md:bottom-[12vh] flex items-center justify-center cursor-pointer bg-[#4289a3] bg-opacity-80 z-50"
    :class="{
  ...
  >
    <div v-if="!isRetracted" class="flex flex-col items-center justify-around w-full h-full text-center">
      ...
      <span class="text-xl text-white writing-mode-vertical-lr pt-4 text-orientation-mixed rotate-180">Kontakt mig</span>
    </div>
